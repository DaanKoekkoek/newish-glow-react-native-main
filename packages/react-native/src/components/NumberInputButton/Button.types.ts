 ...
 * @property {ColorVariant} - Background styling for the button.
 * @property {ColorVariant} - Icon styling for the Button.Icon.
 */
 ...
 */
export interface ButtonIconProps extends Pick<IconProps, "name"> {}
